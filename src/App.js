...
import VisitCountryItem from './components/VisitCountryItem'
...
class App extends Component {
  state = {
    ...
    removeList: initialCountriesList,
  }

  removeCountry = id => {
    const {removeList} = this.state
    const filteredData = removeList.filter(eachCountry => eachCountry.id !== id)
    this.setState({
      removeList: filteredData,
    })
  }
  ...
  render() {
    const {countriesList, removeList} = this.state
